...
var rule = {
    title:'JRKAN直播',
    host:'http://www.jrkan2023.com/?lan=1',
	// JRKAN备用域名:www.jrskan8.com / www.jrkan666.com 
    ...
    double:false,
    推荐:'*',
    // 一级:'.loc_match:eq(2) ul;li:gt(1):lt(4)&&Text;img&&src;li:lt(2)&&Text;a:eq(1)&&href',//play.sportsteam685.com
